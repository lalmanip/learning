...
if [[ -f "$WORKDIR/audio_clean.wav" && "${FORCE_AUDIO:-0}" != "1" ]]; then
  echo "    Reusing existing $WORKDIR/audio_clean.wav"
else
...
drawbox=x=140:y=680:w=460:h=210:color=0x1c2822@1.0:t=fill:enable='between(t\,${MED_START}\,${MED_END})',\
